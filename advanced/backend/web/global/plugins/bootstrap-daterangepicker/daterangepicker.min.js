...
function(t, e) {
    ...
    t.moment || moment, t.jQuery || t.Zepto || t.ender || t.$)
} (this || {},
function(t, e, a, i) {
    var s = function(t, e, s) {
        if (this.parentEl = "body", this.element = i(t), this.startDate = a().startOf("day"), this.endDate = a().endOf("day"), this.minDate = !1, this.maxDate = !1, this.dateLimit = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.showWeekNumbers = !1, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.ranges = {},
        this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyClass = "btn-success", this.cancelClass = "btn-default", this.locale = {
            format: "MM/DD/YYYY",
            separator: " - ",
            applyLabel: "Apply",
            cancelLabel: "Cancel",
        ...
        if ("undefined" == typeof e.startDate && "undefined" == typeof e.endDate && i(this.element).is("input[type=text]")) {
            ...
            r = h = null,
            2 == c.length ? (r = a(c[0], this.locale.format), h = a(c[1], this.locale.format)) : this.singleDatePicker && "" !== o && (r = a(o, this.locale.format), h = a(o, this.locale.format)),
            null !== r && null !== h && (this.setStartDate(r), this.setEndDate(h))
        }
        if ("object" == typeof e.ranges) {
            for (l in e.ranges) {
                r = "string" == typeof e.ranges[l][0] ? a(e.ranges[l][0], this.locale.format) : a(e.ranges[l][0]),
                h = "string" == typeof e.ranges[l][1] ? a(e.ranges[l][1], this.locale.format) : a(e.ranges[l][1]),
                ...
                if (this.dateLimit && r.clone().add(this.dateLimit).isAfter(d) && (d = r.clone().add(this.dateLimit)), d && h.isAfter(d) && (h = d.clone()), !(this.minDate && h.isBefore(this.minDate) || d && r.isAfter(d))) {
                    ...
                    m.innerHTML = l,
                    rangeHtml = m.value,
                    this.ranges[rangeHtml] = [r, h]
                }
            }
            var f = "<ul>";
            for (l in this.ranges) f += "<li>" + l + "</li>";
            f += "<li>" + this.locale.customRangeLabel + "</li>",
            f += "</ul>",
        ...
        if ("function" == typeof s && (this.callback = s), this.timePicker || (this.startDate = this.startDate.startOf("day"), this.endDate = this.endDate.endOf("day"), this.container.find(".calendar-time").hide()), this.timePicker && this.autoApply && (this.autoApply = !1), this.autoApply && "object" != typeof e.ranges ? this.container.find(".ranges").hide() : this.autoApply && this.container.find(".applyBtn, .cancelBtn").addClass("hide"), this.singleDatePicker && (this.container.addClass("single"), this.container.find(".calendar.left").addClass("single"), this.container.find(".calendar.left").show(), this.container.find(".calendar.right").hide(), this.container.find(".daterangepicker_input input, .daterangepicker_input i").hide(), this.timePicker || this.container.find(".ranges").hide()), "undefined" != typeof e.ranges || this.singleDatePicker || this.container.addClass("show-calendar"), this.container.addClass("opens" + this.opens), "undefined" != typeof e.ranges && "right" == this.opens) {
            ...
            u = p.clone();
            p.remove(),
            this.container.find(".calendar.left").parent().prepend(u)
        }
    ...
    s.prototype = {
                ...
                for (var r in this.ranges) {
                    if (this.timePicker) {
                        if (this.startDate.isSame(this.ranges[r][0]) && this.endDate.isSame(this.ranges[r][1])) {
                            s = !1,
                            this.chosenLabel = this.container.find(".ranges li:eq(" + n + ")").addClass("active").html();
                            break
                        }
        ...
        renderCalendar: function(t) {
            ...
            for (var k, v, y = a([f, m, g, 12, h, l]), D = 0, k = 0, v = 0; 42 > D; D++, k++, y = a(y).add(24, "hour")) D > 0 && k % 7 === 0 && (k = 0, v++),
            e[v][k] = y.clone().hour(r).minute(h).second(l),
            y.hour(12),
            this.minDate && e[v][k].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && e[v][k].isBefore(this.minDate) && "left" == t && (e[v][k] = this.minDate.clone()),
            this.maxDate && e[v][k].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && e[v][k].isAfter(this.maxDate) && "right" == t && (e[v][k] = this.maxDate.clone());
            ...
            Y += "<thead>",
            Y += "<tr>",
            this.showWeekNumbers && (Y += "<th></th>"),
            Y += b && !b.isBefore(e.firstDay) || this.linkedCalendars && "left" != t ? "<th></th>": '<th class="prev available"><i class="fa fa-angle-left"></i></th>';
            ...
            if (this.showDropdowns) {
                ...
                S += "</select>";
                for (var B = '<select class="yearselect">',
                E = I; x >= E; E++) B += '<option value="' + E + '"' + (E === M ? ' selected="selected"': "") + ">" + E + "</option>";
                B += "</select>",
                P = S + B
            }
            if (Y += '<th colspan="5" class="month">' + P + "</th>", Y += C && !C.isAfter(e.lastDay) || this.linkedCalendars && "right" != t && !this.singleDatePicker ? "<th></th>": '<th class="next available"><i class="fa fa-angle-right"></i></th>', Y += "</tr>", Y += "<tr>", this.showWeekNumbers && (Y += '<th class="week">' + this.locale.weekLabel + "</th>"), i.each(this.locale.daysOfWeek,
            function(t, e) {
                Y += "<th>" + e + "</th>"
            }), Y += "</tr>", Y += "</thead>", Y += "<tbody>", null == this.endDate && this.dateLimit) {
                var W = this.startDate.clone().add(this.dateLimit).endOf("day"); (!C || W.isBefore(C)) && (C = W)
            }
            for (var v = 0; 6 > v; v++) {
                Y += "<tr>",
                this.showWeekNumbers && (Y += '<td class="week">' + e[v][0].week() + "</td>");
                for (var k = 0; 7 > k; k++) {
                    var j = [];
                    e[v][k].isSame(new Date, "day") && j.push("today"),
                    e[v][k].isoWeekday() > 5 && j.push("weekend"),
                    e[v][k].month() != e[1][1].month() && j.push("off"),
                    this.minDate && e[v][k].isBefore(this.minDate, "day") && j.push("off", "disabled"),
                    C && e[v][k].isAfter(C, "day") && j.push("off", "disabled"),
                    this.isInvalidDate(e[v][k]) && j.push("off", "disabled"),
                    e[v][k].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && j.push("active", "start-date"),
                    null != this.endDate && e[v][k].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && j.push("active", "end-date"),
                    null != this.endDate && e[v][k] > this.startDate && e[v][k] < this.endDate && j.push("in-range");
                    for (var H = "",
                    O = !1,
                    D = 0; D < j.length; D++) H += j[D] + " ",
                    "disabled" == j[D] && (O = !0);
                    O || (H += "available"),
                    Y += '<td class="' + H.replace(/^\s+|\s+$/g, "") + '" data-title="r' + v + "c" + k + '">' + e[v][k].date() + "</td>"
                }
                Y += "</tr>"
            }
            Y += "</tbody>",
            Y += "</table>",
            this.container.find(".calendar." + t + " .calendar-table").html(Y)
        },
        renderTimePicker: function(t) {
            var e, a, i, s = this.maxDate; ! this.dateLimit || this.maxDate && !this.startDate.clone().add(this.dateLimit).isAfter(this.maxDate) || (s = this.startDate.clone().add(this.dateLimit)),
            "left" == t ? (a = this.startDate.clone(), i = this.minDate) : "right" == t && (a = this.endDate ? this.endDate.clone() : this.startDate.clone(), i = this.startDate),
            ...
            for (var n = this.timePicker24Hour ? 0 : 1, r = this.timePicker24Hour ? 23 : 12, h = n; r >= h; h++) {
                ...
                c = !1;
                i && o.minute(59).isBefore(i) && (c = !0),
                s && o.minute(0).isAfter(s) && (c = !0),
                e += l != a.hour() || c ? c ? '<option value="' + h + '" disabled="disabled" class="disabled">' + h + "</option>": '<option value="' + h + '">' + h + "</option>": '<option value="' + h + '" selected="selected">' + h + "</option>"
            }
            e += "</select> ",
            ...
            for (var h = 0; 60 > h; h += this.timePickerIncrement) {
                ...
                o = a.clone().minute(h),
                c = !1;
                i && o.second(59).isBefore(i) && (c = !0),
                s && o.second(0).isAfter(s) && (c = !0),
            ...
            if (e += "</select> ", this.timePickerSeconds) {
                ...
                for (var h = 0; 60 > h; h++) {
                    ...
                    i && o.isBefore(i) && (c = !0),
                    s && o.isAfter(s) && (c = !0),
                    e += a.second() != h || c ? c ? '<option value="' + h + '" disabled="disabled" class="disabled">' + d + "</option>": '<option value="' + h + '">' + d + "</option>": '<option value="' + h + '" selected="selected">' + d + "</option>"
                }
                e += "</select> "
            }
            if (!this.timePicker24Hour) {
                ...
                var m = "",
                f = "";
                i && a.clone().hour(12).minute(0).second(0).isBefore(i) && (m = ' disabled="disabled" class="disabled"'),
                s && a.clone().hour(0).minute(0).second(0).isAfter(s) && (f = ' disabled="disabled" class="disabled"'),
                e += a.hour() >= 12 ? '<option value="AM"' + m + '>AM</option><option value="PM" selected="selected"' + f + ">PM</option>": '<option value="AM" selected="selected"' + m + '>AM</option><option value="PM"' + f + ">PM</option>",
                e += "</select>"
            }
        ...
        clickNext: function(t) {
            var e = i(t.target).parents(".calendar");
            e.hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"), this.linkedCalendars && this.leftCalendar.month.add(1, "month")),
            this.updateCalendars()
        },
        ...
        monthOrYearChanged: function(t) {
            ...
            e || (r < this.startDate.year() || r == this.startDate.year() && n < this.startDate.month()) && (n = this.startDate.month(), r = this.startDate.year()),
            ...
            e ? (this.leftCalendar.month.month(n).year(r), this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(n).year(r), this.linkedCalendars && (this.leftCalendar.month = this.rightCalendar.month.clone().subtract(1, "month"))),
            this.updateCalendars()
        },
        ...
        formInputsChanged: function(t) {
            ...
            s.isValid() && n.isValid() && (e && n.isBefore(s) && (s = n.clone()), this.setStartDate(s), this.setEndDate(n), e ? this.container.find('input[name="daterangepicker_start"]').val(this.startDate.format(this.locale.format)) : this.container.find('input[name="daterangepicker_end"]').val(this.endDate.format(this.locale.format))),
            this.updateCalendars(),
        ...
        elementChanged: function() {
            if (this.element.is("input") && this.element.val().length && !(this.element.val().length < this.locale.format.length)) {
                ...
                e = null,
                i = null;
                2 === t.length && (e = a(t[0], this.locale.format), i = a(t[1], this.locale.format)),
                (this.singleDatePicker || null === e || null === i) && (e = a(this.element.val(), this.locale.format), i = e),
                e.isValid() && i.isValid() && (this.setStartDate(e), this.setEndDate(i), this.updateView())
            }
        },
        keydown: function(t) { (9 === t.keyCode || 13 === t.keyCode) && this.hide()
        },
