...
<div class="row">
	<div class="col-md-12">
		<div class="kode-alert kode-alert-icon kode-alert-click alert7">
			<span>已选择<b class="cart-index-quality">0</b>件商品
			</span><span>总价 : ￥<b class="cart-index-amount">0.00</b></span>
...
// 			alert("可以提交");
	...
	$(".cart-index-checkall").on("click", function(){
		//原来是选中状态，那么就该执行全清操作，点击之后的操作，显示true和false
	...
	$(".cart-index-check").on("click", function(){
		...
		//选中个数
		var clen = 0;
		$(".cart-index-check").each(function(){
			if($(this).prop("checked")==true) {
				clen += 1;
			}
		});
