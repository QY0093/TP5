	...
	<div class="header">
		<div class="headertop_desc">
			...
			<div class="account_desc">
				...
				<?php if(Yii::$app->user->isGuest):?>
					...
					<li><a href="<?php echo Url::to(['/user/signout']);?>">退出</a></li>
					<?php endif;?>
				</ul>
			</div>
			<div class="clear"></div>
		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div class="cart">
			  	   <p><span>购物车:</span><div id="dd" class="wrapper-dropdown-2"> <b class="cart-quality">0</b> 件商品(s) - ￥<b class="cart-amount">0.00</b>
	...
	<div class="header_bottom">
	     	...
	     	<?php 
	     	  $menuItems = [
	     	    ...
	     	    ['label' => '关于', 'url' => ["/index/aboutus"]],
	     	    ['label' => '联系我们', 'url' => ['/index/contact']],
	     	    ['label' => 'GSM手机', 'url' => ['/category/index', 'id' => 3]]
	     	  ];
	     	  echo Nav::widget([
			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="social-icons">
						<h4>Follow Us</h4>
						<ul>
							<li><a href="#" target="_blank"><img src="images/facebook.png"
									alt="" /></a></li>
							<li><a href="#" target="_blank"><img src="images/twitter.png"
									alt="" /></a></li>
							<li><a href="#" target="_blank"><img src="images/skype.png"
									alt="" /> </a></li>
							<li><a href="#" target="_blank"> <img src="images/dribbble.png"
									alt="" /></a></li>
							<li><a href="#" target="_blank"> <img src="images/linkedin.png"
									alt="" /></a></li>
							<div class="clear"></div>
						</ul>
					</div>
...
// 		console.log($(that).data('id'));
    	...
    	//文档开始 。当DOM载入就绪可以查询及操作时绑定一个要执行的函数
