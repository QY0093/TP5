...
<html lang="<?= Yii::$app->language ?>">
  ...
  <!-- ========== Css Files ========== -->
<?php echo HTML::cssFile("@web/css/root.css", ['type' => 'text/css']); ?>
 ...
 <!-- //////////////////////////////////////////////////////////////////////////// --> 
  ...
  <div id="top" class="clearfix">
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox"><img src="img/profileimg.png" alt="img">
      <b><a href="<?php echo Url::to(['/console/index']);?>"><?php echo Yii::$app->user->identity->user_name;?></a></b>
      <span class="caret"></span></a>
        <ul class="dropdown-menu dropdown-menu-list dropdown-menu-right">
          ...
          <li><a href="<?php echo Url::to(['console/signup'])?>"><i class="fa falist fa-power-off"></i> 退出</a></li>
        </ul>
    </li>
